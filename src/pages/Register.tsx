...
import { Eye, EyeOff, FileSpreadsheet, User, Mail, Lock } from 'lucide-react';
      ...
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
        <div className="lg:flex flex-col justify-center hidden">
          ...
          <p className="text-lg text-gray-600">
            Create your free account and get access to hundreds of Excel templates and tutorials.
          </p>
          <img
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 lg:p-10">
          ...
          <p className="text-gray-600 mb-8">Join thousands of Excel learners today</p>
