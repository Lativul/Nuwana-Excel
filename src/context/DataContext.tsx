...
const initialVideoCourses: VideoCourse[] = [
...
const initialMedia: MediaFile[] = [
  { id: 1, name: 'Budget Planner Thumbnail', type: 'image' as const, format: 'JPG', size: '1.2 MB', url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=300&fit=crop', thumbnail: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=300&fit=crop', category: 'Thumbnails', alt: 'Budget Planner Template', published: true },
